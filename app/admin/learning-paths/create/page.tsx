...
export default function CreateLearningPathPage() {
  ...
  const loadTools = async () => {
    try {
      ...
      console.log('✅ Loaded tools:', toolsList.length);
      setAvailableTools(toolsList);
    } catch (error) {
      console.error('❌ Error loading tools:', error);
      alert('เกิดข้อผิดพลาดในการโหลด Tools');
    } finally {
      setLoading(false);
    }
  };
  ...
  const updateStep = (index: number, field: keyof Step, value: any) => {
    ...
    // If toolId changed, reset videoId
    if (field === 'toolId') {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await addDoc(collection(db, 'learningPaths'), learningPathData);

      alert('✅ สร้าง Learning Path เรียบร้อยแล้ว!');
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">
              ➕ สร้าง Learning Path ใหม่
            </h1>
            <p className="text-gray-600">
              เพิ่มเส้นทางการเรียนใหม่ลงในระบบ
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="เช่น เส้นทางผู้เริ่มต้น AI"
                    required
                  />
                </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="md:col-span-2">
                          ...
                          <input
                            ...
                            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500"
                            placeholder="เช่น ขั้นตอนที่ 1: รู้จัก ChatGPT"
                            required
                          />
                        </div>
            ...
            <div className="flex items-center justify-between">
              ...
              >
                ...
                {saving ? 'กำลังบันทึก...' : 'บันทึก Learning Path'}
              </button>
            </div>
          </form>
        </div>
